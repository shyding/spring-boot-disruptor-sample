...
public class DisruptorConfig {
	...
	@Scheduled(fixedDelay = 1) // 每1s执行1次
	public void send() throws Exception {
		...
		event.setKey("email-id1-" + Math.random());
	...
	public void send2() throws Exception {
		...
		event.setKey("sms- id2-" + Math.random());
	...
	public void send3() throws Exception {
		...
		event.setEvent("Event-Output");
		event.setTag("TagA-Output");
		event.setKey("email-id3-" + Math.random());
	...
	public void send4() throws Exception {
		...
		event.setEvent("Event-Output");
		event.setTag("TagA-Output");
		event.setKey("email-id4-" + Math.random());
